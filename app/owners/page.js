                ...
                <div className="page-header-bar">
                    <div className="max-w-7xl mx-auto flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-xl font-black text-white leading-none">مالکین</h1>
                                <p className="text-xs mt-1" style={{ color: 'rgba(255,255,255,0.75)' }}>({allData.length} مالک)</p>
                            </div>
                        </div>
                        <Link href="/owners/create"><button className="btn btn-success"><FontAwesomeIcon icon={faPlus} className="w-4 h-4" />مالک جدید</button></Link>
                    </div>
                </div>
