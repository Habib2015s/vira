// app/notifications/_components/NotifItem.js
'use client'
...
export function NotifItem({ notif, index, onMarkRead, onDelete }) {
    ...
    return (
        <motion.div
            ...
            style={{
                background:   notif.unread ? 'var(--primary-subtle)' : 'transparent',
                borderRight:  notif.unread ? '3px solid var(--primary)' : '3px solid transparent',
            }}
            ...
            <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2">
                    <p className="text-sm font-bold leading-snug" style={{ color: 'var(--text)' }}>
                        {notif.unread && (
                            <span className="inline-block w-1.5 h-1.5 rounded-full ml-1.5 align-middle"
