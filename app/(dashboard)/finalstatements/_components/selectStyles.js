...
export const selectStyles = {
    ...
    option:     (b, s) => ({ ...b, borderRadius: 'var(--radius-sm)', margin: '2px 0', cursor: 'pointer', fontSize: '13.5px', background: s.isSelected ? 'var(--primary)' : s.isFocused ? 'var(--surface-2)' : 'transparent', color: s.isSelected ? 'var(--surface)' : 'var(--text)' }),
