...
const selectStyles = {
    ...
    option:      (b, s) => ({ ...b, borderRadius: 'var(--radius-sm)', background: s.isSelected ? 'var(--primary)' : s.isFocused ? 'var(--surface-2)' : 'transparent', color: s.isSelected ? 'var(--surface)' : 'var(--text)', fontSize: '13.5px' }),
