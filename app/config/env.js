...
export const ENV = {
    ...
    API_TM_REQUESTS_SET_FINAL_STATEMENT:
        `${RS}/tmRequests/setTmRequestFinalStatement`,
    ...
    API_WAREHOUSE_REQUESTS_IMPORT_ALL:
        `${WH}/requests/importOrExportAll`,
    API_WAREHOUSE_REQUESTS_IMPORT_ONE:
        `${WH}/requests/importOrExportOne`,
    API_WAREHOUSE_TRANSFERS:
        `${WH}/transfer_between_storehouses`,
    API_WAREHOUSE_IMPORTS:
        `${WH}/imports_and_exports`,
    ...
    API_PERMISSIONS_UPGRADE:
        `${V1}/permissions/upgradePermission`,
}