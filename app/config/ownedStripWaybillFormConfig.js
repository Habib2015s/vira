// app/config/ownedStripWaybillFormConfig.js
// کانفیگ فرم ملکی - استریپ
...
export const ownedStripWaybillFormConfig = {
    tabs: [
    ...
    fields: {
        ...
        basic: [
            ...
            { name: 'refineryWaybillNumber', label: 'شماره بارنامه پالایشگاهی', type: 'text' },
            { name: 'issuingCompany', label: 'شرکت صدور بارنامه', type: 'select2', loadOptions: 'loadCompanies' },
        ...
        vehicle: [
            ...
            { name: 'driverType', label: 'نوع بارگیر', type: 'select', required: true, options: [
                    { value: '', label: 'انتخاب کنید' },
                    { value: 'کفی', label: 'کفی' },
                    { value: 'تانکر', label: 'تانکر' },
                    { value: 'چادری', label: 'چادری' },
                    { value: 'اتاق', label: 'اتاق' },
                    { value: 'ایزوله', label: 'ایزوله' }
                ]},
