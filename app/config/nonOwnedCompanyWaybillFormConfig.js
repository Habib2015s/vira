// app/config/nonOwnedCompanyWaybillFormConfig.js
// کانفیگ فرم غیرملکی-شرکتی
...
export const nonOwnedCompanyWaybillFormConfig = {
    tabs: [
    ...
    fields: {
        basic: [
            ...
            { name: 'statusConfirm', label: 'وضعیت ثبت', type: 'select', required: false, section: 'cargoBase', gridCols: 1, options: [
        ...
        income: [
            ...
            { name: 'companyCommission', label: 'کمیسیون شرکتی', type: 'text', required: false, section: 'financialIncome', gridCols: 1, showZeroText: true },
            { name: 'penalty', label: 'جریمه', type: 'text', required: false, section: 'financialIncome', gridCols: 1, showZeroText: true },
            { name: 'driverPayment', label: 'پرداختی به راننده', type: 'text', required: false, section: 'financialIncome', gridCols: 1, showZeroText: true },
            { name: 'commissionScale', label: 'میزان کمیسیون', type: 'select', required: false, section: 'financialIncome', gridCols: 1, options: [
                    { value: '17.50', label: '۱۷.۵۰' },
                    { value: '19.50', label: '۱۹.۵۰' }
                ]},
        ...
        account: [
            { name: 'shabaNumber', label: 'شماره شبا', type: 'text', placeholder: 'IR...', required: false, section: 'accountInfo', gridCols: 1 },
            { name: 'bankName', label: 'نام بانک', type: 'select2', required: false, section: 'accountInfo', gridCols: 1, loadOptions: 'loadBanks' },
            { name: 'accountHolder', label: 'نام صاحب حساب', type: 'text', required: false, section: 'accountInfo', gridCols: 1 }
        ],
